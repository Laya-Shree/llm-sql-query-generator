...
@st.cache_resource
def get_cached_llm():
    return GoogleGenerativeAI(google_api_key=api_key, model="gemini-2.0-flash", temperature=0.2)
...
def get_cached_vectorstore():
    ...
    return Chroma.from_texts(to_vectorize, embedding=embeddings, metadatas=few_shots)
